 ...
 */
@FunctionDef
public class TtdStringStartsWithFunction extends StringStartsWithFunction implements TtdAviatorDefineFun {
    private static final long serialVersionUID = 9071009020940674979L;

    public TtdStringStartsWithFunction() {
        super();
    }

    @MethodName(prefix = "string", method = "starts_with",
            paramType = {"字符串", "前缀"},
            desc = "是否给定前缀开头",
            returnObj = "布尔值")
