 ...
 */
@FunctionDef
public class TtdSeqAddFunction extends SeqAddFunction implements TtdAviatorDefineFun {
    private static final long serialVersionUID = 9071009020940674991L;

    public TtdSeqAddFunction() {
        super();
    }

    @MethodName(prefix = "seq", method = "add",
            desc = "向序列中添加一个元素",
            paramType = {"序列", "元素"},
            returnObj = "序列")
