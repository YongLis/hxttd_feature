 ...
 */
@FunctionDef
public class TtdSeqAddAllFunction extends SeqAddAllFunction implements TtdAviatorDefineFun {
    private static final long serialVersionUID = 9071009020940674992L;

    public TtdSeqAddAllFunction() {
        super();
    }

    @MethodName(prefix = "seq", method = "add_all",
            desc = "将第二个序列中的所有元素添加到第一个序列中",
            paramType = {"序列", "序列"},
            returnObj = "序列")
