package com.ly.ttd.biz.feature.dem.sweb.controller.feature;

import com.ly.ttd.base.exception.BizException;
import com.ly.ttd.base.result.PageResult;
import com.ly.ttd.base.result.Result;
import com.ly.ttd.biz.feature.dem.sweb.common.ConditionExpressOpEnum;
...
public class FeatureConfigController {
    ...
    public Result<Boolean> add(@Valid @RequestBody FeatureConfigAddReq req) {
        try {
            featureConfigAdminService.add(req);
    ...
    public Result<Boolean> update(@Valid @RequestBody FeatureConfigUpdateReq req) {
        try {
            featureConfigAdminService.update(req);
            return Result.success();
        } catch (BizException e) {
            return Result.error(e.getCode(), e.getMessage());
        } catch (Exception e1) {
    ...
    public Result<Boolean> delete(@Parameter(description = "特征配置ID") @RequestParam Long id) {
        try {
            featureConfigAdminService.delete(id, LoginUser.getLoginUserName());
