...
public interface HttpConnectorService {
     ...
     */
    Long add(HttpConnectorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    void update(HttpConnectorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    HttpConnectorDto queryById(Long id) throws BizException;
}
