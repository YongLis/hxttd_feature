...
public interface EsConnectorService {
     ...
     */
    Long add(EsConnectorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    void update(EsConnectorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    EsConnectorDto queryById(Long id) throws BizException;
}
