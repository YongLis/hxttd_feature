...
public interface FeatureFactorService {
     ...
     */
    Long add(FactorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    void update(FactorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    FactorDto queryById(Long id) throws BizException;
}
