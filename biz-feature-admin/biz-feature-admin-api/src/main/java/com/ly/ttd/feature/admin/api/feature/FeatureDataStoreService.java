...
public interface FeatureDataStoreService {
     ...
     */
    Long add(FeatureDataStoreDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    void update(FeatureDataStoreDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    FeatureDataStoreDto queryById(Long id) throws BizException;
}
