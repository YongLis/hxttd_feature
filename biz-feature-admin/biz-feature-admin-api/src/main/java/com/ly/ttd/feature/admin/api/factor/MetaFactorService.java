...
public interface MetaFactorService {
     ...
     */
    Long add(MetaFactorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    void update(MetaFactorDto dto) throws BizException;
     ...
     * @throws BizException 业务异常
     */
    MetaFactorDto queryById(Long id) throws BizException;
}
