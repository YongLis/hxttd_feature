...
public class FeatureFactorOpService extends AbstractResourceOpService {
    ...
    public void add(BaseDto req) throws FeatureBizException {
        FactorDto addReq = (FactorDto) req;
        FeatureConfigEntity config = featureConfigMapper.selectByFeatureCode(addReq.getRefFeatureCode());
    ...
    private FactorEntity buildFeatureFactorEntity(FactorDto addReq) {
        ...
        entity.setRefFeatureCode(addReq.getRefFeatureCode());
        return entity;
    }
    ...
    public void update(BaseDto req) throws FeatureBizException {
        FactorDto updateReq = (FactorDto) req;
