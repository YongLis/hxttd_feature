...
public class HttpConnectorOpService extends AbstractResourceOpService {
    ...
    public void add(BaseDto req) throws FeatureBizException {
        HttpConnectorDto addReq = (HttpConnectorDto) req;
        String key = projectService.getResourceKey(addReq.getProjectId(),
                FeatureResourceType.CONNECTOR_HTTP.getPrefix(), addReq.getResourceKey());
        ...
        HttpConnectorModel model = buildModel(addReq);
    ...
    public void update(BaseDto req) throws FeatureBizException {
        HttpConnectorDto updateReq = (HttpConnectorDto) req;
        ...
        HttpConnectorModel model = buildModel(updateReq);
        entity.setResourceJson(JSON.toJSONString(model));
    ...
    private HttpConnectorModel buildModel(HttpConnectorDto req) {
        HttpConnectorModel model = new HttpConnectorModel();
        model.setUrl(req.getUrl());
        model.setMethod(req.getMethod());
        model.setHeader(req.getHeader());
        model.setParam(req.getParam());
