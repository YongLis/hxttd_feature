...
public class FactorCalculateServiceImpl implements FactorCalculateService, FeatureConfigurationAware {
    ...
    private void calculateDerivedFactorValue(String parentFactorCode, TxnParamContext ctx) throws FeatureBizException {
    ...
    private Object getDerivativeFactorValue(String parentFactorCode, DerivativeFactorModel configDto, TxnParamContext ctx) throws FeatureBizException {
